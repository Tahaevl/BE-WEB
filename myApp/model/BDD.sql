...
INSERT INTO `identification` (`idUser`, `nom`, `prenom`, `mail`, `motPasse`, `statut`) VALUES
(1, 'Blériot', 'Louis', 'louis.bleriot@enac.fr', 'a', 0),
(2, 'Boucher', 'Hélène', 'helene.boucher@enac.fr', 'b', 1),
(3, 'admin', 'admin', 'admin@enac.fr', 'admin', 1),
(4, 'Ader', 'Clément ', 'clement.ader@enac.fr', 'ader', 0),
(5, 'Aubrun', 'Émile', 'emile.aubrun@enac.fr', 'aubrun', 1),
(6, 'Carpentier', 'Roger', 'roger.carpentier@enac.fr', 'carpentier', 1),
(7, 'Farman', 'Henri', 'henri.farman@enac.fr', 'farman', 1),
(8, 'Daurat', 'Didier', 'didier.daurat@enac.fr', 'daurat', 1),
(9, 'Mermoz', 'Jean', 'jean.mermoz@enac.fr', 'mermoz', 1),
(10, 'Wright', 'Katharine', 'katharine.wright@enac.fr', 'wright', 1),
(11, 'Peltier', 'Therese', 'therese.peltier@enac.fr', 'peltier', 1),
(12, 'De Laroche', 'Raymonde', 'raymonde.delaroche@enac.fr', 'delaroche', 1),
(13, 'Earhart', 'Amelia', 'amelia.earhart@enac.fr', 'earhart', 1);
