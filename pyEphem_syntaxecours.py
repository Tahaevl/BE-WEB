...
DB_SERVER = mysql.connector.connect(user="root", password="",host="localhost",port=3306,database="ienac21_elhassouni_gonzalez_houze_locatelli ",raise_on_warnings=True)
...
def insert(dic):
    ...
    for x,y in dic.items() :
        try:
            ...
            argument=y.ap #en °
            sql = "INSERT INTO satellites (idSatellite ,nomSatelitte ,category ,orbite ,longitude ,latitude ,altitude ,inclinaison ,longitudeNoeud ,anomalieMoyenne ,semiMajorAxis ,semiMinorAxis ,arg ,source ,idUser, idPays) VALUES ( %s , %s , %s , %s , %s , %s , %s , %s , %s , %s , %s , %s , %s , %s , %s , %s)"
            ...
            msg = "Failed download : {}".format(err)
        ids +=1
    return msg
